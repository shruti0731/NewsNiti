...
function TopHeadlines({ user, theme, toggleTheme, onAddNote }) {
  ...
  useEffect(() => {
    ...
    setSelectedCategory(params.category || "Top Headlines");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-indigo-50 via-white to-indigo-50">
      ...
      <main className="container mx-auto max-w-7xl px-4 py-8 md:py-12">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-indigo-900 mb-8 text-center capitalize">
          {categoryTitle}
        </h1>
        {error && (
